...
if __name__ == '__main__':
    num_input_neurons = int(sys.argv[1])
    num_hidden_neurons = int(sys.argv[2])
    num_output_neurons = int(sys.argv[3])
    DrawNN([num_input_neurons, num_hidden_neurons, num_output_neurons]).draw()
